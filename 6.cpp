...
HuffNode* HuffmanConstruction(int frequency[], char letter[], int size, struct HuffNode* completeHuffmanTree)
{
...
void createTheCode(struct HuffNode* completeHuffmanTree)
{
	...
	completeHuffmanTree = HuffmanConstruction(frequencies, letter, index);
