// I'm trying to use the array of frequencies and letter to compare with the letter from the input file
// for encoding, then use it to search the required frequency, then print out the binary code.
